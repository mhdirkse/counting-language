...
public class IntegrationUnhappyTest implements OutputStrategy
{
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][] {
            ...
            {"print [1, 2].reverse(1)", "Argument count mismatch calling array<int>.reverse. Expected 0, got 1"},
            {"print [1, 2].ascendingIndicesOf()", "Argument count mismatch calling array<int>.ascendingIndicesOf. Expected 1, got 0"},
            {"print [1, 2].ascendingIndicesOf(true)", "Type mismatch calling function array<int>.ascendingIndicesOf, formal parameter 1"},
            ...
            {"print [1, 2].addAll()", "Argument count mismatch calling array<int>.addAll. Expected 1, got 0"},
            {"print [1, 2].addAll(3)", "Type mismatch calling function array<int>.addAll, formal parameter 1"},
            {"print [1].delete(2)", "Index 2 out of bounds"},
            {"print [1].delete(0)", "Index 0 out of bounds"},
            {"print [1].update(true, 1)", "Type mismatch"},
            {"print (distribution 1).probabilityOf()", "Argument count mismatch"},
            {"print (distribution 1).probabilityOf(true)", "Type mismatch calling function"},
            {"print distribution<int>.probabilityOf(1)", "Division by zero"},
            {"print (distribution 1).probabilityOfUnknown(1)", "Argument count mismatch"},
            {"print distribution<int>.probabilityOfUnknown()", "Division by zero"},
            ...
            {"print properWhole(5)", "Type mismatch calling function"},
            {"print properWhole(1/2, 2)", "Argument count mismatch"},
            {"print isWhole(1, 2)", "Argument count mismatch"},
            {"print isWhole(1)", "Type mismatch calling function"},
        });
    }
