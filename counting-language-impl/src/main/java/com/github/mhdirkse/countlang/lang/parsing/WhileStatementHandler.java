...
class WhileStatementHandler extends AbstractExpressionHandler implements StatementSource {
    private WhileStatement statement;
    
    WhileStatementHandler(final int line, final int column) {
        super();
        statement = new WhileStatement(line, column);
    }
    ...
    void addExpression(ExpressionNode expression) {
        statement.setTestExpr(expression);
    }
