...
* `com.github.mhdirkse.countlang.execution`: Helper classes to support verifying and executing an AST.
...
* `com.github.mhdirkse.countlang.tasks`: Tasks to be performed by the counting-language software, independent from the user interface applied to call them. This package also checks the correctness of counting-language programs.
* `com.github.mhdirkse.countlang.steps`: Executes counting-language programs.
